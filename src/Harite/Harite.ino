...
uint8_t countChannelC = 0;
uint8_t conutChannelA = 0;
...
void odriveInit()
{
  ...
  odrive.InputTorque(motorNumber0, 1.2);
  odrive.InputTorque(motorNumber1, 1.2);
}
...
void readPositionMotor0()
{
  float motor0Position = odrive.GetPosition(0);
  Serial.println(motor0Position);
}

void readPositionMotor1()
{
  float motor0Position = odrive.GetPosition(1);
  Serial.println(motor0Position);
}
